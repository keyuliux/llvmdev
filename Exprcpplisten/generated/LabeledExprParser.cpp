...
void LabeledExprParser::BlankContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<LabeledExprListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterBlank(this);
}
void LabeledExprParser::BlankContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<LabeledExprListener *>(listener);
  if (parserListener != nullptr)
...
LabeledExprParser::Initializer::Initializer() {
  ...
  _serializedATN = {
    ...
    0x5, 0x2, 0x4, 0x6, 0x2, 0x4, 0x3, 0x2, 0x6, 0x7, 0x3, 0x2, 0x8, 0x9, 
    ...
    0x7, 0xa, 0x2, 0x2, 0x1b, 0x1c, 0x7, 0x4, 0x2, 0x2, 0x1c, 0x1d, 0x5, 
